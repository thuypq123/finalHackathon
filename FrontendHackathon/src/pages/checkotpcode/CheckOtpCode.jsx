      ...
      <div className="checkOtpPage">
        <div className="checkOtpContainer">
          ...
          <div className="checkOtpWrapper">
            <h2>
              Nhập mã OTP mà chúng tôi đã gởi tới email {emailOtpCheck} để xác
              nhận đăng ký
            </h2>
            <div className="checkOtpStyleInput">
              <input
                type="number"
                placeholder="Nhập mã OTP tại đây"
                className="checkOtpTextInput"
                onInput={(e) => (e.target.value = e.target.value.slice(0, 6))}
                ref={otpRef}
              />
            </div>

            <button className="btnButton btnConfirm" onClick={handleSubmit}>
              Xác nhận
            </button>
          </div>
        </div>
